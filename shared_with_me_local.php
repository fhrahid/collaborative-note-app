                        ...
                        <div class="note-card">
                            <div class="shared-indicator">
                                ...
                                <span class="permission-indicator permission-<?php echo $note['permission']; ?>">
                                    <?php echo $note['permission'] === 'edit' ? '✏️ Edit' : '👀 Read'; ?>
                                </span>
                            </div>
                            <h3 class="note-title">
                                <a href="view_shared_note_local.php?id=<?php echo $note['id']; ?>">
                            ...
                            <div class="note-meta">
                                ...
                                <div class="note-actions">
                                    <a href="view_shared_note_local.php?id=<?php echo $note['id']; ?>" class="btn btn-small btn-primary">👀 View</a>
                                    <?php if ($note['permission'] === 'edit'): ?>
                                        <a href="edit_shared_note_local.php?id=<?php echo $note['id']; ?>" class="btn btn-small btn-secondary">✏️ Edit</a>
                                    <?php endif; ?>
                                </div>
                            </div>
                        </div>
